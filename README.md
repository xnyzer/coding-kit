...
| `/coding-kit:update-conventions` | Konventions-Sync Template → Projekte (nur abwärts): Diff + Bestätigung je Datei bzw. je Standards-Fragment, Override-Schutz, Altprojekt-Migrationen; projektlokale Fragmente werden mit manuell anstoßbarem Übernahme-Vorschlag fürs Template gemeldet. |
